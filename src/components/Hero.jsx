      ...
      <div className="wrap hero__grid">
        <div className="hero__copy">
          ...
          <h1 style={{ marginTop: 18 }}>
            Helping every kid<br />
            <span className="mark"><span>sound&nbsp;it&nbsp;out</span></span> — and<br />
        ...
        <div className="hero__art">
          <div className="hero__photo">
            <video
              ...
              playsInline
              preload="metadata"
              aria-label="A woman tutoring a young girl in speech therapy"
            >
  ...
  return (
    <section className="mission" id="who" style={{ backgroundColor: "rgb(20, 24, 33)" }}>
      <div className="wrap mission__inner">
        ...
        <div className="stats">
          <div className="stat"><div className="n" style={{ color: "rgb(191, 167, 224)" }}><CountUp to={120} /></div><div className="l">Sequenced lessons, free to download</div></div>
          <div className="stat"><div className="n green"><CountUp to={130} suffix="+" /></div><div className="l">Decodable stories across 10 groups</div></div>
          <div className="stat"><div className="n red"><CountUp to={0} prefix="$" /></div><div className="l">Cost — now and forever</div></div>
        </div>
      </div>
    </section>
  );
